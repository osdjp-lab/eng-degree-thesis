...
These specifications extend far beyond the scope of this project as such only the \gls{lsb} Core subset of the \gls{lsb} standard has been considered for use in the creation of the \gls{lfl} system.
