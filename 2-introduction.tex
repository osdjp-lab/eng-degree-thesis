...
The focus of this thesis is the creation of the \enquote{\glsxtrlong{lfl}} system \cite{lfl}. This system consists of minimal implementations of commonly used software and is intended for use as a teaching resource for study and modification by junior programmers.

\subsection{Free and open source software}

\gls{foss} is software that simultaneously adheres to two definitions: the definition of free software provided by the \gls{fsf} \cite{fsf} and the definition of open source software provided by the \gls{osi} \cite{osi}.
...
\gls{foss} is distributed under one or many compatible licences. The following are a few key examples of \gls{foss} licences:

\begin{itemize}
    \item \glsxtrshort{cc0}, Unlicense - public domain or equivalent.
    \item \glsxtrshort{bsd}, \glsxtrshort{mit}, Apache - permissive.
    \item \glsxtrshort{agpl}, \glsxtrshort{gpl} - protective (copyleft).
\end{itemize}
