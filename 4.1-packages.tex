...
Packages excluded from the initial LSB Core set of standard packages.
...
\begin{table}[!h]
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Packages excluded from the LSB Core standard set of packages grouped by rejection criterion.}
\end{table}
