...
\begin{table}[!ht]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        & ex \cite{ex-vi} \footnotemark[4] & 23 481 \\
        \cline{2-3}
        ...
        \cline{2-3}
        & lcc \cite{lcc} \footnotemark[5] & 27 736 \\
        \cline{2-3}
...
\footnotetext[4]{Non-\gls{osi} open source free software licence.}
\footnotetext[5]{Non-\gls{foss} open source licence.}
