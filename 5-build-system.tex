...
The final steps required to set up the system are run in isolation on the created root filesystem via chroot and include the indexing of manual pages, the addition of the root user and the change of directory ownership.
