...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Evaluate included programs and features in context of the \glsxtrshort{unix} philosophy in search of a modular minimal optimal subset of interoperable composable commands.
    \end{itemize}
\end{itemize}
